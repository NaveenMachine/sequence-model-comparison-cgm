...
def parse_glucose_data(xml_file_path):
    ...
    # print(f"Attempting to open file at absolute path: {absolute_file_path}") # Removed verbose print
...
# --- Main Script Logic (Modified for Mamba with Prediction Interval) ---

def train_glucose_mamba(train_xml_file_path, test_xml_file_path, look_back=10, prediction_steps_ahead=1, epochs=50, batch_size=32,
    ...
    """Trains and evaluates a Mamba-like model for glucose prediction with a specified horizon."""
    ...
    inputs = Input(shape=(look_back, d_model))
...
if __name__ == "__main__":
    ...
    model_save_filename = f'glucose_mamba_model_{patientNum}_{PREDICTION_HORIZON_MINUTES}min.h5'
