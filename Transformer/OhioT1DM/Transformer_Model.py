...
if __name__ == "__main__":
    ...
    output_folder_name = 'patient-591-transformer' # Changed folder name
    script_dir = os.path.dirname(os.path.abspath(__file__))
    ...
    model_save_filename = 'glucose_transformer_model_591.h5' # Changed filename
    stats_save_filename = 'glucose_prediction_statistics_591_transformer.txt' # Changed filename
    loss_plot_filename = 'glucose_training_loss_591_transformer.png' # Changed filename
    prediction_plot_filename = 'glucose_test_predictions_591_transformer.png' # Changed filename
